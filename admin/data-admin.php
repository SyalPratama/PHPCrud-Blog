...
$admin = mysqli_query($conn, "SELECT * FROM admin ORDER BY id DESC"); // Sesuaikan dengan nama tabel admin kamu
?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="edit_admin.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">
    ...
    button.addEventListener('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `proses_admin.php?hapus=${adminId}`;
            }
        });
    });
});
